...
import { Check, Circle, Edit2, Trash2, Eye, Filter, ChevronLeft, ChevronRight, Search, Download, Upload, X, Loader2 } from 'lucide-react';
...
export function TaskTable({ tasks: propTasks, loading: propLoading }: TaskTableProps) {
  const { tasks: contextTasks, toggleComplete, deleteTask, createTask, loading: contextLoading } = useTasks();
